          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-white to-[#E8F0F8] p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-100">
              ...
              <div className="space-y-4">
                ...
                <a href="#contact">
                  <Button variant="outline" className="w-full border-secondary text-secondary hover:bg-secondary/80 hover:text-secondary/80">
                    Anfragen
                  </Button>
                </a>
              </div>
            ...
            <div className="bg-gradient-to-br from-white to-[#E8F0F8] p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <a href="#contact">
                  <Button variant="outline" className="w-full border-primary text-primary hover:bg-primary/80 hover:text-primary/80">
                    Anfragen
                  </Button>
                </a>
              </div>
